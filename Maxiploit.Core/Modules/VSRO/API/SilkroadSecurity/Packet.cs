...
namespace Maxiploit.Modules.VSRO.API.SilkroadSecurity {
    public class Packet
    {
        ...
        public void WriteAscii(String value, int code_page)
        {
            lock (m_lock)
            {
                ...
                //string utf8_value = Encoding.UTF7.GetString(codepage_bytes);
                //byte[] bytes = Encoding.Default.GetBytes(codepage_bytes);
